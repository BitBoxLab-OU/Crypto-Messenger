...
namespace EncryptedMessaging
{
    ...
    public class Context
    {
        ...
        public void AddCloudManager(ICloudManager cloudManager)
        {
            ...
            void sendCommand(ushort command, byte[][] parameters) => Messaging.SendCommandToSubApplication(CloudManager.Cloud, cloudAppId, (ushort)command, false, true, parameters);
